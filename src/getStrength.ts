...
export function getStrength(
  ...
  if (score <= 2) return { label: "Слабый",   color: "#e53935", width: "18%"  };
  if (score <= 3) return { label: "Средний",  color: "#fb8c00", width: "45%"  };
  if (score <= 5) return { label: "Хороший",  color: "#43a047", width: "72%"  };
